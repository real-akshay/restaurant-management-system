...
<head>
    ...
    <!-- <script type="text/javascript"
        src="../wp-content/plugins/woocommerce/js/jquery-blockui/jquery.blockUI.mina7df.js"
        id="jquery-blockui-js" data-wp-strategy="defer"></script> -->
    ...
    <script type="text/javascript" id="wc-checkout-js-extra">
        /* <![CDATA[ */
        var wc_checkout_params = { "ajax_url": "\/themes\/restaurant\/wp\/demo\/restaurant\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/themes\/restaurant\/wp\/demo\/restaurant\/?wc-ajax=%%endpoint%%", "update_order_review_nonce": "9c5ef6c87e", "apply_coupon_nonce": "9746f42dd9", "remove_coupon_nonce": "8b023c2d69", "option_guest_checkout": "yes", "checkout_url": "\/themes\/restaurant\/wp\/demo\/restaurant\/?wc-ajax=checkout", "is_checkout": "1", "debug_mode": "", "i18n_checkout_error": "There was an error processing your order. Please check for any charges in your payment method and review your <a href=\"https:\/\/www.nicdark-themes.com\/themes\/restaurant\/wp\/demo\/restaurant\/my-account\/orders\/\">order history<\/a> before placing the order again." };
        /* ]]> */
    </script>
    <script type="text/javascript"
...
<body id="start_nicdark_framework"
    class="page-template-default page page-id-873 theme-ristorante nd_options_customizer_fonts nd_options_customizer_forms woocommerce-checkout woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-5.6 vc_responsive">
                ...
                <div data-vc-full-width="true" data-vc-full-width-init="false" data-vc-stretch-content="true"
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-6">
                        <div class="vc_column-inner">
                            <div class="wpb_wrapper">
                                <div
                                    class="  nd_options_menu_component nd_options_section nd_options_menu_component_440">
                                ...
                                <style>
                                    .nd_options_menu_component_440 ul.menu {
                                        margin: 0px;
                                        padding: 0px;
                                        list-style: none;
                                        display: inline-block;
                                    ...
                                    .nd_options_menu_component_440>div {
                                        float: left;
                                        width: 100%;
                                        text-align: center;
                                    }

                                    .nd_options_menu_component_440 ul.menu>li {
                                        margin: 0px;
                                        padding: 0px;
                                        display: inline-block;
                                    }

                                    .nd_options_menu_component_440 ul.menu>li a {
                                        color: #ffffff;
                                        font-weight: normal;
                                        font-size: 14px;
                                        line-height: 14px;
                                    ...
                                    /*dropdown*/
                                    .nd_options_menu_component_440 div>ul li:hover>ul.sub-menu {
                                        display: block;
                                    }

                                    .nd_options_menu_component_440 div>ul li>ul.sub-menu {
                                        margin-left: 0px;
                                        padding-top: 0px;
                                        width: 195px;
                                        z-index: 999;
                                    ...
                                    .nd_options_menu_component_440 div>ul li>ul.sub-menu>li {
                                        padding: 15px 25px;
                                        border-bottom: 1px solid #f1f1f1;
                                        text-align: left;
                                        background-color: #fff;
                                    ...
                                    .nd_options_menu_component_440 div>ul li>ul.sub-menu>li:hover {
                                        background-color: #f9f9f9;
                                    }

                                    .nd_options_menu_component_440 div>ul li>ul.sub-menu>li:last-child {
                                        border-bottom: 0px solid #000;
                                    }

                                    .nd_options_menu_component_440 div>ul li>ul.sub-menu li a {
                                        font-size: 14px;
                                        float: left;
                                        width: 100%;
                                        margin: 0px;
                                    ...
                                    .nd_options_menu_component_440 div>ul li>ul.sub-menu li>ul.sub-menu {
                                        margin-left: 165px;
                                        top: 0;
                                        padding-top: 0;
                                        padding-left: 25px;
                                    ...
                                    .nd_options_menu_component_440 div>ul li>ul.sub-menu li.menu-item-has-children>a:after {
                                        content: "";
                                        float: right;
                                        border-style: solid;
                            ...
                            <div class="wpb_wrapper">
                                ...
                                <script type="text/javascript">
                                    ...
                                    jQuery(document).ready(function () {
                                        ...
                                        jQuery(function ($) {
                                            ...
                                            $(".nd_options_open_sidebar_441").on("click", function (event) {

                                                //add rule to main container only if the component is in header
                                                if ($("#nd_options_header_5 .nd_options_open_sidebar_content_441, #nd_options_header_5_mobile .nd_options_open_sidebar_content_441").length) {
                                                    $(".nicdark_site > .nd_options_container").css({ "position": "relative", "z-index": "0" });
                                                }

                                                //open sidebar
                                                $(".nd_options_open_sidebar_content_441").css({ "right": "0px", });

                                            });

                                            //CLOSE sidebar content ( navigation 2 )
                                            $(".nd_options_close_sidebar_441").on("click", function (event) {

                                                $(".nd_options_open_sidebar_content_441").css({ "right": "-300px" });
                                ...
                                <div style="text-align:right;" class="nd_options_section">
                                    <img decoding="async" alt="" style="width:25px;"
                                        class=" nd_options_cursor_pointer nd_options_open_sidebar_441 nd_options_margin_0 nd_options_padding_0 "
                                ...
                                <div style="background-color:#2d2d2d; width:300px; right:-300px;"
                                    class="nd_options_open_sidebar_contentt nd_options_open_sidebar_content_441 nd_options_box_sizing_border_box nd_options_overflow_hidden nd_options_overflow_y_auto nd_options_transition_all_08_ease nd_options_height_100_percentage nd_options_position_fixed nd_options_top_0 nd_options_z_index_999">

                                    <img decoding="async" style="right:20px; top:20px;" alt="" width="20"
                                        class="nd_options_close_sidebar_441 nd_options_cursor_pointer nd_options_z_index_9 nd_options_position_absolute"
                            ...
                            <div class="col-1">
                                ...
                                <div class="woocommerce-billing-fields">
                                    ...
                                    <div class="woocommerce-billing-fields__field-wrapper">
                                        ...
                                        <p class="form-row form-row-wide address-field validate-required"
                                            id="billing_city_field" data-priority="70"><label for="billing_city"
                                        ...
                                        <p class="form-row form-row-wide address-field validate-required validate-state"
                                            id="billing_state_field" data-priority="80"><label for="billing_state"
                                                ...
                                                class="woocommerce-input-wrapper"><select name="billing_state"
                                                    id="billing_state" class="state_select " aria-required="true"
                                        ...
                                        <p class="form-row form-row-wide address-field validate-required validate-postcode"
                                            id="billing_postcode_field" data-priority="90"><label for="billing_postcode"
                                                class="">ZIP Code&nbsp;<abbr class="required"
                                                    title="required">*</abbr></label><span
                                                class="woocommerce-input-wrapper"><input type="text" class="input-text "
                                    ...
                                    <h3 id="ship-to-different-address">
                                        <label
                                            ...
                                            <input id="ship-to-different-address-checkbox"
                                                ...
                                                type="checkbox" name="ship_to_different_address" value="1" /> <span>Ship
                                        ...
                                        <div class="woocommerce-shipping-fields__field-wrapper">
                                            ...
                                            <p class="form-row form-row-last validate-required"
                                                id="shipping_last_name_field" data-priority="20"><label
                                                    ...
                                                    class="woocommerce-input-wrapper"><input type="text"
                                                        ...
                                                        aria-required="true" autocomplete="family-name" /></span></p>
                                            ...
                                            <p class="form-row form-row-wide address-field validate-required validate-state"
                                                id="shipping_state_field" data-priority="80"><label for="shipping_state"
                                                    ...
                                                    class="woocommerce-input-wrapper"><select name="shipping_state"
                                                        id="shipping_state" class="state_select " aria-required="true"
                                                        autocomplete="address-level1"
                                            ...
                                            <p class="form-row form-row-wide address-field validate-required validate-postcode"
                                                id="shipping_postcode_field" data-priority="90"><label
                                                    for="shipping_postcode" class="">ZIP Code&nbsp;<abbr
                                                        class="required" title="required">*</abbr></label><span
                                                    class="woocommerce-input-wrapper"><input type="text"
                                                        class="input-text " name="shipping_postcode"
                                                        id="shipping_postcode" placeholder="" value=""
                                                        aria-required="true" autocomplete="postal-code" /></span></p>
                                        </div>
                        ...
                        <div id="order_review" class="woocommerce-checkout-review-order">
                            <table class="shop_table woocommerce-checkout-review-order-table">
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($query_run) > 0) {
                                        foreach ($query_run as $product) {
                                            ?>
                                            <tr class="cart_item">
                                                <!-- extra code for sending data to order_process.php -->
                                                ...
                                                <td class="product-total">
                                                    <span class="woocommerce-Price-amount amount"><bdi><span
                                                                class="woocommerce-Price-currencySymbol">&#8377;</span><?= $product['subtotal_amount'] ?></bdi></span>
                                                </td>

                                            </tr>
                                            <?php
                                            $total += intval($product['subtotal_amount']);
                                ...
                                <tfoot>
                                    ...
                                    <tr class="cart-subtotal">
                                        <th>subTotal</th>
                                        <!-- extra code for sending data to order_process.php -->
                                        <input type="hidden" name="items_subtotal_amount" value="<?= $total ?>">
                                        <!--  -->
                                            ...
                                            <ul id="shipping_method" class="woocommerce-shipping-methods">
                                                <li>
                                                    <input type="hidden" name="shipping_method[0]" data-index="0"
                                                        id="shipping_method_0_flat_rate1" value="flat_rate:50"
                                    ...
                                    <tr class="order-total">
                                        ...
                                        <td><strong><span class="woocommerce-Price-amount amount"><bdi><span
                                                            class="woocommerce-Price-currencySymbol">&#8377;</span><?= $total + 50 ?></bdi></span></strong>
                                        </td>
                                    </tr>
                            ...
                            <div id="payment" class="woocommerce-checkout-payment">
                                ...
                                <div class="form-row place-order">
                                    ...
                                    <?php $_SESSION['order_status'] = 'Pending'; ?>
                                    ...
                                    <input type="hidden" id="woocommerce-process-checkout-nonce"
                                        name="woocommerce-process-checkout-nonce" value="dd5450f626" /><input
                                        type="hidden" name="_wp_http_referer"
                                        value="/themes/restaurant/wp/demo/restaurant/checkout/" />
                                </div>
                            </div>
                        </div>
